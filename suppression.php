...
$sql = "DELETE from candidat where Num_ut=:Num_ut";
    ...
    <div class="tout">
        <div class="card">
            ...
            <div class="header">
                ...
                <div class="content">
                    <span class="title">Votre candidature a bien été supprimée</span>
                    <p class="message">Merci et au plaisir de vous revoir. Vous allez maintenant être redirigé vers
                        notre
